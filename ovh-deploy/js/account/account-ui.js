  ...
  card.innerHTML = `
    ...
    <div class="ac-form">
      ...
      <label class="ac-checkbox-label">
        ...
        <span>
          J'accepte les
          <a href="/cgu" target="_blank" rel="noopener noreferrer" class="ac-link">CGU</a>
          et la
          <a href="/politique-confidentialite" target="_blank" rel="noopener noreferrer" class="ac-link">Politique de confidentialité</a>.
        </span>
      </label>
...
function _renderConnected() {
  ...
  setTimeout(() => {
    document.getElementById('ac-signout')?.addEventListener('click', async () => {
      await signOut();
    });
  }, 0);
