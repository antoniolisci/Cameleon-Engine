...
export const MARKET_VISUALS = {
  RANGE: {
    ...
    decisionTone: "Sortie de range non confirmée.",
  ...
  COMPRESSION: {
    ...
    decisionTone: "Déclenchement non confirmé.",
  ...
  BREAKOUT: {
    ...
    decisionTone: "Signal de sortie présent, confirmation absente.",
  ...
  TREND: {
    ...
    decisionTone: "Direction présente — momentum en cours.",
    overlayStrength: 0.54,
    blurLevel: 1,
    imageOpacity: 0.25,
    imagePosition: "center center",
  ...
  DEFENSE: {
    ...
    decisionTone: "Conditions de risque élevé identifiées.",
    overlayStrength: 0.58,
    blurLevel: 1,
    imageOpacity: 0.22,
    imagePosition: "center center",
  ...
  UNKNOWN: {
    ...
    decisionTone: "Informations insuffisantes pour une lecture complète.",
    overlayStrength: 0.58,
    blurLevel: 1,
    imageOpacity: 0.2,
    imagePosition: "center center",
