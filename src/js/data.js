...
export const MARKET_STATES = {
  RANGE: {
    ...
    verdict: "Aucune position à prendre",
    posture: "Ne prends aucune position",
    action: "Attends confirmation",
  ...
  COMPRESSION: {
    ...
    verdict: "Marché en attente — pas de signal exploitable",
    posture: "Attends confirmation",
    action: "Attends confirmation",
    avoid: "Entrée non valide",
  ...
  BREAKOUT: {
    ...
    verdict: "Tu peux agir",
    posture: "Accompagne le mouvement",
    action: "Entre avec confirmation",
    avoid: "Entrée non valide",
  ...
  TREND: {
    ...
    verdict: "Tendance exploitable — opportunité en cours",
    posture: "Reste aligné",
    action: "Entre sur retracement",
  ...
  DEFENSE: {
    ...
    verdict: "Réduis ton exposition",
    posture: "Sois prudent",
    action: "Attends confirmation",
    avoid: "Risque trop élevé",
  ...
  UNKNOWN: {
    ...
    verdict: "Attends",
    posture: "Attends confirmation",
    action: "Ne prends aucune position",
    avoid: "Entrée non valide",
